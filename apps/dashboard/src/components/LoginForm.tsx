    ...
    <div class="auth-card">
      ...
      <div class="auth-card-body">
        ...
        <div class="oauth-buttons">
          <a href={`${API}/auth/github/login?audience=dashboard`} class="btn oauth-btn">
          ...
          <a href={`${API}/auth/google/login?audience=dashboard`} class="btn oauth-btn">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div class="field">
            ...
            >
              <label for="login-password" style={{ margin: 0 }}>
                Password
              </label>
