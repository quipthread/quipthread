-- Schema exported from ghcr.io/quipthread/quipthread:0.1.1.
-- Source: e0989d04b9942042c8559ca43c8a2ba3777a1a77, backend/db/shared.go.
...
CREATE TABLE sites (
    ...
    created_at  DATETIME DEFAULT CURRENT_TIMESTAMP
, last_notified_at DATETIME, theme TEXT NOT NULL DEFAULT 'auto');
