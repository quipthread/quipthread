import { intro, outro, select, text, isCancel, cancel, log, note } from '@clack/prompts'
import { writeFile, mkdir } from 'fs/promises'
import { join, dirname } from 'path'
import { detectFramework } from './detect.js'
import { generateFiles, generateVanillaSnippet, type Config } from './templates.js'
...
async function main() {
  ...
  const rawSiteId = await text({
    message: 'Site ID  (from your Quipthread admin dashboard → Sites)',
  ...
  outro('Quipthread is ready. Happy commenting!')
}
